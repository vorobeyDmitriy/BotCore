...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BotCore.Core.Test.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("BotCore.Core.Test.Entities.UserCurrencyMapping", b =>
                {
            ...
            modelBuilder.Entity("BotCore.Core.Test.Entities.UserCurrencyMapping", b =>
                {
                    b.HasOne("BotCore.Core.Test.Entities.Currency", "Currency")
                        .WithMany("UserCurrencyMapping")
                        .HasForeignKey("CurrencyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BotCore.Core.Test.Entities.User", "User")
                        .WithMany("UserCurrencyMapping")
